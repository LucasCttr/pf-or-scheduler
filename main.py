...
# Ventana de limpieza entre cirugias consecutivas dentro de un mismo bloque
# (en minutos). Se resta de la capacidad disponible del quirofano y no se
# considera tiempo ocioso. Ajustar este valor para simular protocolos de
# limpieza mas cortos o mas largos.
CLEANING_MINUTES = 15
...
def build_result_dict(days, rooms, best_chromosome, best_fitness, best_agenda,
    ...
    for day in days:
        ...
        for room in rooms:
            ...
            agenda_detalle[day][room.id] = {
                ...
                "minutos_limpieza": best_agenda.cleaning_time.get(block, 0),
    ...
    return {
        ...
        "parametros": {
            "minutos_limpieza_entre_cirugias": ga.cleaning_minutes,
        },
